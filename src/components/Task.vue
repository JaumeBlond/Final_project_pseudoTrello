<template>
    <div class="task rounded-lg bg-white p-4 flex justify-between items-start cursor-pointer mt-4 w-4/5"
        @click="editTask" @dragstart="dragStart">
        <div class="w-4/5">
            <h2 class="sm:text-s md:text-m lg:text-l xl:text-l 2xl:text-xl font-bold mb-2 w-4/5 line-clamp-2">{{
            task.title }}</h2>
            <p class="text-sm">{{ task.description }}</p>
            <div class="flex items-center mt-2">
                <div class="flex items-center pr-24">
                    <!-- Priority icons based on the number received -->
                    <svg v-if="task.priority === 0" width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" fill="white" />
                        <path d="M17 9.5L12 14.5L7 9.5" stroke="green" stroke-linecap="round" stroke-width="3"
                            stroke-linejoin="round" />
                    </svg>
                    <svg v-else-if="task.priority === 1" width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" fill="white" />
                        <path d="M6 14H18" stroke="#000000" stroke-width="3" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M6 10H18" stroke="#000000" stroke-width="3" stroke-linecap="round"
                            stroke-linejoin="round" />
                    ...
                    <svg v-else width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                        ...
                        <path d="M7 14.5L12 9.5L17 14.5" stroke="red" stroke-linecap="round" stroke-width="3"
                            stroke-linejoin="round" />
                    </svg>
                </div>
            </div>
        ...
        <div class="w-1/5 flex justify-between">
            <button @click.stop="editTask" class="edit-button">
                <svg fill="#000000" height="16px" width="16px" viewBox="0 0 306.637 306.637"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-width="20" d="M12.809,238.52L0,306.637l68.118-12.809l184.277-184.277l-55.309-55.309L12.809,238.52z M60.79,279.943l-41.992,7.896
            l7.896-41.992L197.086,75.455l34.096,34.096L60.79,279.943z" />
                    <path stroke-width="20" d="M251.329,0l-41.507,41.507l55.308,55.308l41.507-41.507L251.329,0z M231.035,41.507l20.294-20.294l34.095,34.095
