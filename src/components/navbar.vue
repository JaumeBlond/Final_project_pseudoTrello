<template>
  <nav
    class="navbar h-24 w-full bg-gray-200 py-3 border-b border-gray-300 place-content-center"
  >
    <div class="container flex justify-between items-center mx-auto">
      ...
      <div class="navbar-links flex items-center mx-6 w-1/4 justify-around">
        ...
        <button
          @click="logout"
          class="logout-button ml-4 bg-transparent border border-gray-500 px-3 py-1 rounded text-gray-800"
        >
          Logout
        </button>
      </div>
